...
class TurtleMover(Node):
    def __init__(self):
        ...
        self.publisher_turtle1 = self.create_publisher(Twist, '/turtle1/turtle1/cmd_vel', 10)
        self.publisher_turtle2 = self.create_publisher(Twist, '/turtle2/turtle1/cmd_vel', 10)
    ...
    def move_turtles(self):
        ...
        if self.t < side_duration:
            ...
            twist_square.linear.x = 0.0  # Gira 90 graus
            twist_square.angular.z = math.pi / 2
        else:
